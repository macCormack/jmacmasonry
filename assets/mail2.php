<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $recipient = "info@jmacmasonry.com";
        ...
        $email_headers = "From: $name <info@jmacmasonry.com>";

        // Send the email.
        if (mail($recipient, $subject, $email_content, $email_headers)) {
            // Set a 200 (okay) response code.
            http_response_code(200);
            echo "Thank You! Your message has been sent. I will be in touch with you as soon as possible";
        } else {
